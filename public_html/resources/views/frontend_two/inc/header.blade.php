            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    ...
                    <div class="logo"> <a href="home.html">
                            ...
                            @endphp
                            @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" class="mw-100 h-30px h-md-40px" height="40" alt="logo">
                            @else
                            <img src="{{asset('assets/website/assets/')}}/assets/images/logo.png" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40">
                            @endif
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <div class="cart-item product-summary">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <div class="image"> <a href="detail.html"><img src="{{asset('assets/website/assets/')}}/assets/images/cart.jpg" alt=""></a> </div>
                                        </div>
                                        <div class="col-xs-7">
                                        ...
                                        <li>
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{{asset('assets/website/assets/')}}/assets/images/banners/top-menu-banner.jpg" alt=""> </div>
                                                    <!-- /.yamm-content -->
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner"> <a href="#"><img alt="" src="{{asset('assets/website/assets/')}}/assets/images/banners/banner-side.png"></a> </div>
                                                </div>
                                                <!-- /.row -->
                                            </div>
                                            <!-- /.yamm-content -->
